# -*- coding: utf-8 -*-
"""
Created on Wed May 10 15:13:17 2023

@author: muhamzs
Physics Informed Machine learning (Double Pendulum Example)
"""
...
# Initial conditions: angles start at pi/2, angular velocities start at zero
y0 = [np.pi/2, 0, np.pi/2, 0]

# Use odeint to solve the differential equations
...
# Use the LSTM model to predict the states of the system
